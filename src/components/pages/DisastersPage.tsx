...
import { Search, MapPin, Clock, ArrowUpRight, AlertTriangle, X, ShieldCheck, GitBranch } from 'lucide-react';
          ...
          {filtered.map((incident) => {
            ...
            return (
              ...
              >
                ...
                <div className="pt-3 border-t border-paper-200 flex flex-wrap items-center justify-between gap-2 text-xs font-mono text-charcoal-500">
                  ...
                  {onNavigate && (
                    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      <button
                        ...
                        className="px-2 py-1 rounded-lg bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-200 text-[10px] font-mono font-bold flex items-center gap-1 transition-colors"
                        title="View cascading consequence chain"
                      >
                      ...
                      <button
                        ...
                        className="px-2 py-1 rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-900 border border-emerald-200 text-[10px] font-mono font-bold flex items-center gap-1 transition-colors"
                        title="View citizen life safety guide"
                      >
