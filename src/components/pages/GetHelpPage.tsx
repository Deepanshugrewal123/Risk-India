...
export const GetHelpPage: React.FC = () => {
  ...
  return (
    <div className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="mb-6 p-3.5 rounded-2xl bg-amber-50 border border-amber-300 text-amber-950 text-xs font-mono flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <AlertOctagon className="w-4 h-4 text-amber-700 shrink-0" />
          <span>
            <strong>EMERGENCY NOTICE:</strong> For immediate emergencies, contact local emergency services and follow official government instructions.
          </span>
        </div>
        <span className="shrink-0 text-[10px] text-amber-800 font-bold uppercase">
          OFFICIAL PROTOCOL
        </span>
      </div>
